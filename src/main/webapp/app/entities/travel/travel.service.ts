...
export class TravelService {
    ...
    private convertDateFromClient(travel: ITravel): ITravel {
        const copy: ITravel = Object.assign({}, travel, {
            departureDate: travel.departureDate != null && travel.departureDate.isValid() ? travel.departureDate.toJSON() : null,
            arrivalDate: travel.arrivalDate != null && travel.arrivalDate.isValid() ? travel.arrivalDate.toJSON() : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((travel: ITravel) => {
            ...
            travel.arrivalDate = travel.arrivalDate != null ? moment(travel.arrivalDate) : null;
        });
        return res;
    }
}
